...
__To create a repository based on the Community Specification Temmplate:__
The [Community Specification](https://github.com/CommunitySpecification/Community_Specification). The only way to create a repository **`MYSPEC`** is by using the GitHub web interface and copying the template into **`MYORG`**. 

> Please don't use `Fork` or `Clone` operations as this will provide you with a new template.
...
The system will create a repository on **MYORG** account containing all the Governance and Development files. 

If your plan is to have a single repository to develop technical documents you can move to [Step 3](#step_3).
...
If you are creating multiple **MYSpec** repositories, remember that to name one of the repositories as **Governance**. This repository will be customized in [Step 2](#step_2) & [Step 3](#step_3).

Once you have created all the repositories _(included the **Governance** repo)_, then go to [Step 2](#step_2)

## Step 2
At the end of this step, you will have a single repository called **Governance** and one or more repositories to develop Technical Specifications.
