...
>If the Organization has a single repository, then the `governance` repository is  not needed. In this case, the documents listed above and and the Technical Specifications are stored and developed in **`MYSPEC`** repository. 

* **`MYSPEC`**: one or more of this repository. Each one contains the substance of the Specification that you're developing.
...
**To create repositories with the GitHub web interface.**

> Please use the GitHub web interface for this step, don't use `Fork` or `Clone` operations as this will provide you with a repository template.

> * Go to [Community Specification](https://github.com/CommunitySpecification/Community_Specification) template repository
> * Select `Use this template` on the top menu of the GitHub page, and click the button.
...
> * Untick `Include all branches`, you don't need them.
> * Click the `Create repository from template` button.

GitHub platform will create a repository on your **MYORG** account containing all the Governance and Development files. 

If your plan is to have a single repository to develop Technical Specificiations you can move to [Step 3](#step_3).

If you want more than one repository to develop Technical Specifications, then please repeat [Step 1](#step_1) for each new repository. _(Provide different names for each new Technical Specifications repo)_. 

When creating multiple **MYSpec** repositories, remember that to name one of them as **Governance**. This repository will be customized in [Step 2](#step_2) & [Step 3](#step_3) with only Governance documents.

Once you have created all the repositories _(included the **Governance** repo)_, then go to [Step 2](#step_2)

## Step 2
### Delete Unncessary Documents
...
> This step is used if you are having more than one repository to build Technical Specifications. If you Organization contains a single Technical repository, then please to [Step 3](#setp_3)

**Governance** repository will contain only documents related to the *process*. These documents are:
* **Community Specification License**
* **Governance**
* **Code of Conduct**
* **Organization Process**

**MySpecs** repositories will contain only contain documents used to develop Technical Specifications. These documents are:
...
**To delete unwanted documents in a repository using GitHub web interface**

> * Go to the repository where you want to delete documents
> * Click on the document to delete. _(A new page will open)_.
> * Click on the `delete` icon on the left-hand side of the screen
> * Insert a _Title_ and _Description_ for this delete
...
> These steps assume that you have WRITE access to the repository.

Once you have deleted all the unwanted documents, then move to [Step 3](#step_3).

## Step 3
### Customize Governance and Development documents
In this step, we will customize the documents  in the single repository, or in the multiple repositories _(if you have performed [Step 2](#step_2))_

As mentioned previously, the Community Specifications contain two different set of documents: _Governance_ and _Development_ documents. These are the changes:
