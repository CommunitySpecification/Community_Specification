...
> The diagram below depictures the process for creating one or multiple Community Specification repositories from the CS Template repository.

![image](https://user-images.githubusercontent.com/3258579/199836799-f785ea1b-0f1c-4a73-b3f3-912fc77ec298.png)
...
The system will create a repository on **MYORG** account with the name provided. 

If your plan is to have a single repository to develop technical documents you can move to [step 2](#step_2).

If you would like to create more than one repository to develop Technical Specifications, then please repeat [Step 1](#step_1) for each new repository. _(Provide different names for each new Technical Specifications repo)_
