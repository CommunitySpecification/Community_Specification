...
> This step is only used if you are having more than one repository to build Technical Specifications. If you Organization contains a single Technical repository, then please to [Step 3](#setp_3)

**Governance** repository will contain only documents related to the *process*:
* Community Specification License
* Governance
* Code of Conduct
* Organization Process

**MySpecs** repositories will contain only contain documents used to develop Technical Specifications: 
