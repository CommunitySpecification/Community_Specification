...
This guide describes the steps to take within GitHub to implement the Community Specification license and governance process for a new project, where multiple specification documents can each be developed in their own repositories.
