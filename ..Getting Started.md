# Setting up Community Specification v1.1 for a GitHub Organization

## Overview and Scope

This guide describes the steps to take within GitHub to implement the [Community Specification v1.1](https://github.com/CommunitySpecification/Community_Specification/tree/V1.1) license and governance process for a new project, where multiple specification documents can each be developed in their own repositories.
...
* **`governance`** -- your (optional) repository to expand your Organization process
...
Assuming that a new repository **`governance`** was created, then update the `README.md` file as follow:
