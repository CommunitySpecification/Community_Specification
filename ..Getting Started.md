...
* **Code of Conduct**
  * You should **not** modify this document either. The link inside of this document points to the *Code of Conduct* document maitained by JDF/LF on the [SC_Reference](https://github.com/CommunitySpecification/CS_Reference) repository.
...
* **Specifications** folder
  ...
  * The folder contains one or more *Technical* documents based on the *CS_Template*. This template contains all the relevant sections used by an *Standards Development Organization* to build its *Technical Specifications*.

* **Release Planning.md**

  * The *Release_Planning* document contains a table with technical features and release milestones.
  * Update this table with technical features or documents and deadlines by when when the group plans to complete them.
