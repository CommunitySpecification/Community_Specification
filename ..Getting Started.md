...
**Governance** repository only contain documents related to the *process*. These documents are:
* **Community Specification License**
* **Governance**
* **Code of Conduct**
* **Organization Process**

**MySpecs** repositories only contain documents used to develop Technical Specifications. These documents are:
...
In this step, we will customize the documents  in the single repository, or on the multiple repositories _(if you have performed [Step 2](#step_2))_
