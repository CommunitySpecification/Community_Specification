...
* **`MYSPEC`**: contains the substance of the Specification that you're developing
...
![image](https://user-images.githubusercontent.com/3258579/199851593-176cbaa6-040d-4b97-a1b5-d1295c14a97f.png)
...
**To delete unwanted documents using GitHub web interface**

> * Go to the repository where you want to delete documents
> * Click on the document file to delete
...
Repeat the above steps to delete unwanted documents on the repositories.

> These steps assuming that you have WRITE access to the repository
