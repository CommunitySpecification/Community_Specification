...
2.- The next stage is the development of Technical documents; see [Specifications Development Stages]() for further information. 

3.- After completing the Development of Technical Documents, the next stage is the [Consistency Reivew](). In this step, it is essential to incorporate people that didn't participate in the Development of the Technical Documents created by the Working Group. The stage's main objective is to validate the content and clarity of the Technical Documents; specifically, the content doesn't contain mistakes or is open for interpretation. 

4.- The next stage is the [Approval]() of the Technical Document by the Working Group. 

5.- After Working Group Approval, the next stage is the [Ratification]() of the Technical Documents by the parent group, in most cases, the Technical Steering Committee. The project's legal terms are bound to the technical content at this stage.

6.- The final stage is the [Publication]() of the Technical 
