...
This document provides the governance policy for specifications and other documents or artifacts, such as web pages or source code or schema files, developed using the Community Specification process in a repository (each a “Working Group”).  Each Working Group and must adhere to the requirements in this document.
