...
This document provides the contribution policy for specifications and other documents or artifacts developed using the Community Specification process in a repository (each a “Working Group”).  Additional or alternate contribution policies may be adopted and documented by the Working Group.
